...
public class Texture2dProgram {
    ...
    public Texture2dProgram(ProgramType programType) {
        ...
        Log.d(TAG, "Texture2dProgram program " + mProgramHandle + " (" + mProgramType + ")");
        switch (programType) {
            case TEXTURE_2D:
...
//        GlUtil.checkLocation(muKernelLoc,"uKernel");
        Log.d(TAG, "muKernelLoc " + muKernelLoc);
        if (muKernelLoc < 0) { // no kernel in this one
            ...
            GlUtil.checkLocation(mProgramHandle, "uTexOffset");
            muColorAdjustLoc = GLES20.glGetUniformLocation(mProgramHandle, "uColorAdjust");
            GlUtil.checkLocation(mProgramHandle, "uColorAdjust");
    ...
    public void draw(float[] mvpMatrix, FloatBuffer vertexBuffer, int firstVertex,
        ...
        GLES20.glUniformMatrix4fv(muMVPMatrixLoc, 1, false, mvpMatrix, 0); //mvpMatrix现在用的单元矩阵，等于没设置
        GlUtil.checkGlError("glUniformMatrix4fv");

        // Copy the texture transformation matrix over.
        GLES20.glUniformMatrix4fv(muTexMatrixLoc, 1, false, texMatrix, 0);
        GlUtil.checkGlError("glUniformMatrix4fv texMatrix");

        // Enable the "aPosition" vertex attribute.
        GLES20.glEnableVertexAttribArray(maPositionLoc);
        GlUtil.checkGlError("glEnableVertexAttribArray");
        // Connect vertexBuffer to "aPosition".  set data
        ...
        GLES20.glVertexAttribPointer(maTextureCoordLoc,
                2,
                GLES20.GL_FLOAT,false,texStride,texBuffer);// Connect texBuffer to "aTextureCoord".
        ...
        // Release resources -- disable vertex array, texture, and program.
